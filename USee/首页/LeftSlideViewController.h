...
#define kScreenSize           [[UIScreen mainScreen] bounds].size                     //侧滑的封装
...
#define kLeftCenterX 0 //85 //左侧初始偏移量
...
typedef NS_ENUM(NSUInteger, LeftViewType) {
    LeftViewTypeMain,
    LeftViewTypeGoodsRank,
    LeftViewTypeKeyPoint,
    LeftViewTypeStoreRank,
    LeftViewTypeGoods,
    LeftViewTypeGuide,
    NOLeftViewType = -1
};
...
@property (nonatomic) NSInteger currentLeftViewType;
