...
@interface MiMaDetailViewController ()<CircleViewDelegate>
...
- (void)viewDidLoad {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"MiMaDetailViewController" forKey:@"crashTheClassName"];
...
- (void)circleView:(PCCircleView *)view type:(CircleViewType)type didCompleteSetSecondGesture:(NSString *)gesture result:(BOOL)equal
{
    ...
    if (equal) {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:@"1" forKey:@"states"];

        
        [[NSNotificationCenter defaultCenter] postNotificationName:@"gestureSetVCDismis" object:nil];
       ...
       [self dismissViewControllerAnimated:YES completion:^{
        ...
        if (self.isChangeGesture) {
            ...
            [[NSNotificationCenter defaultCenter]postNotificationName:@"changeSeccessForReturnLeftMenuSSMMVC" object:nil];
        }
...
- (void)leftBarBtnClicked:(UIButton *)button {
    ...
    if (self.isChangeGesture) {
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"backToLeftMenuSSMMVC" object:nil];
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"closeSwitchOFSSMM" object:nil];
        [self dismissViewControllerAnimated:YES completion:^{
