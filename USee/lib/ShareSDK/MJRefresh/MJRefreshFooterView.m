...
- (void)layoutSubviews
{
    ...
    if (self.mj_width > SCREEN_WIDTH + 10) {
        self.statusLabel.frame = CGRectMake(-25, 0, self.bounds.size.width, self.bounds.size.height);
    }
    else{
        self.statusLabel.frame = CGRectMake(15, 0, self.bounds.size.width, self.bounds.size.height);    }
