...
- (NSInteger)yearsAfterDate:(NSDate *) aDate {
    NSDateComponents *components = [[NSDate AZ_currentCalendar] components:NSCalendarUnitYear fromDate:aDate toDate:self options:0];
    return [components year];
}

- (NSInteger)yearsBeforeDate:(NSDate *) aDate {
    NSDateComponents *components = [[NSDate AZ_currentCalendar] components:NSCalendarUnitYear fromDate:self toDate:aDate options:0];
    return [components year];
}
